  ...
  return (
    <Container as="section" size="lg" className={className} {...props}>
      <Backdrop spacing="md" className="px-4 lg:px-12">
        <div className="flex flex-col max-w-6xl gap-12 xl:gap-18">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex flex-col gap-12 lg:flex-row lg:items-start">
              <Typography variant="body" color="neutral" className="flex-1 leading-8">
                {t("home.description")}
              </Typography>

              <div className="flex flex-col shrink-0 gap-4">
                {md ? <CopyInput variant="terminal" value={INSTALL_COMMANDS} /> : null}
