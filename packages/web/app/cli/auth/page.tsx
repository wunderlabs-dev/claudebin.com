...
const AuthContent = () => {
  ...
  return (
    <div className="text-center">
      <h1 className="mb-2 text-2xl font-bold">Authenticate Claudebin CLI</h1>
      ...
      <button
        type="button"
        className="inline-flex items-center gap-3 rounded-lg bg-neutral-800 px-6 py-3 font-medium transition-colors hover:bg-neutral-700"
      >
        <GitHubIcon />
        Sign in with GitHub
      </button>
