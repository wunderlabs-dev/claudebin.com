...
const createComponents = (role: Role) => ({
  ...
  code: ({ children }: { children?: ReactNode }) => (
    <code className="max-w-full overflow-x-auto scrollbar-hidden whitespace-nowrap rounded-sm bg-gray-200 px-2 py-0.5 font-mono text-base text-gray-600">{children}</code>
  ),
