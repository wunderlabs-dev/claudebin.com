    ...
    variants: {
      variant: {
        ...
        secondary: [
          ...
          "active:to-gray-150 active:border-gray-150 active:shadow-ridge-t",
          "disabled:bg-gray-150 disabled:text-gray-400 disabled:border-gray-150",
        ],
        outline: [
        ...
        circle: [
          ...
          "disabled:bg-gray-150 disabled:text-gray-400 disabled:border-transparent",
        ],
      },
      color: {
        default: [],
    ...
    compoundVariants: [
      {
        ...
        color: "success",
        className:
          "bg-green-50/10 border-green-50 hover:bg-green-50/20 active:bg-green-50/10",
      },
    ],
    defaultVariants: {
      variant: "default",
